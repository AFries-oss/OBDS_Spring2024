...
#create mapping qc files, change the batch memory 2G and threads ntasks =1
samtools flagstat /project/orms0158/1_linux/rnaseq/mapped_reads/ERR1755082_sorted.bam > ./mapped_reads/ERR1755082.flagstat
samtools idxstats /project/orms0158/1_linux/rnaseq/mapped_reads/ERR1755082_sorted.bam > ./mapped_reads/ERR1755082.idxstats
