...
samtools view -bh -@12 /project/orms0158/1_linux/rnaseq/mapped_reads/ERR1755082.sam > ./mapped_reads/ERR1755082.bam

#use samtools to sort the .bam file  
samtools sort -@12 /project/orms0158/1_linux/rnaseq/mapped_reads/ERR1755082.bam > ./mapped_reads/ERR1755082_sorted.bam

#use  samtools index to sort the sorted.bam file
samtools index -@12 /project/orms0158/1_linux/rnaseq/mapped_reads/ERR1755082_sorted.bam

# once running well, can remove the intermediate files ERR1755082.bam and ERR1755082_sorted.bam using rm code 
