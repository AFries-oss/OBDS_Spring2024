...
#using featureCounts
# -a is annotation file, -o is the output fil, input_file is  sorted.bam, 
featureCounts \
 -t exon \
 -p \
 -T 12 \
 -g gene_id \
 -a /project/orms0158/1_linux/rnaseq/genome/Mus_musculus.GRCm38.102.gtf.gz  \
 -o counts.txt \
 -s 2\
 --countReadPairs \
 -B -C  \
 /project/orms0158/1_linux/rnaseq/mapped_reads/ERR1755082_sorted.bam 
